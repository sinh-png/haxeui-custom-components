...
class Main extends Sprite {
	...
	public function new() {
		...
		Toolkit.openFullscreen(function(root:Root) {
			...
			var item1 = tree.treeRoot.addItem( { text: "Item 1", icon: "img/icons/folder.png" } );
			var item2 = tree.treeRoot.addItem( { text: "Item 2" } );
			var item3 = tree.treeRoot.addItem( { text: "Item 3" } );
			
			item1.addItem( { text: "Item 1.1" } ); 
			var item2_1 = item2.addItem( { text: "Item 2.1", icon: "img/icons/folder.png" } );
			item3.addItem( { text: "Item 3.1", icon: "img/icons/burger.png" } ); 
			
			item2_1.addItem( { text: "Item 2.1.2", icon: "img/icons/cherry.png" } );
			item2_1.addItem( { text: "Item 2.1.3", icon: "img/icons/butterfly.png" } );
			var item2_1_4 = item2_1.addItem( { text: "Item 2.1.4", icon: "img/icons/folder.png" } );
